# 💰 MyTwoCents – Controle Financeiro

**MyTwoCents** é uma aplicação de controle financeiro pessoal poderosa e intuitiva, convertida em um **aplicativo Desktop nativo** para máxima performance e privacidade. Gerencie receitas, despesas e assinaturas com uma interface moderna e relatórios automatizados.

---

## 📸 Visão Geral

O MyTwoCents oferece uma experiência de "Aplicativo Standalone" usando JavaFX WebView, integrando uma interface rica em Javascript com o poder e segurança do Java/Spring Boot no backend.
...
- **Persistência:** H2 Database (modo arquivo em `~/.mytwocents/data`)
...
- **Exportação Inteligente**: Relatórios em **PDF** e **CSV** com nomes de arquivo dinâmicos (ex: `MyTwoCents - 2026 - Abril - Receitas.pdf`).
...
Para garantir a segurança e facilidade de backup, o MyTwoCents salva os dados na pasta pessoal do seu usuário:

- **Caminho:** `/home/USUARIO/.mytwocents/data.mv.db`
